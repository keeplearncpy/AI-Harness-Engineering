...
- **Downstream**: harness-data-model, harness-backend, harness-frontend, harness-testing
...
5. **scope_hint** (optional): Analysis scope hint (full | single_feature | module_scope)
...
|-------------|-------------|-------------|
| feature-{id}.md | workspace/{project}/docs/feature-{id}.md | One FSD per feature module |
| SSD Update | workspace/{project}/docs/SSD-SystemOverview.md | Append/update system overview |
| INDEX.md Update | workspace/{project}/docs/INDEX.md | Update document index |
